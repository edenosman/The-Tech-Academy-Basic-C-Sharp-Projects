...
namespace Calling_Methods_Assignment
{
    class Program
    {
        ...
        {
            Console.WriteLine("You've encountered Spartan and he launches a surprise attack.");
            ...
            Console.WriteLine("Your healer, Helen is near by. She will heal you with her staff.");
